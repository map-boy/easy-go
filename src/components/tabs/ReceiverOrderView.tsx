...
const DEMO_FOODS: FoodItem[] = [
  ...
  { id: 'c1', name: 'Burger + Fries + Soda',         description: 'Juicy beef burger with crispy fries and a cold soda.',               ingredients: 'Beef patty, bun, lettuce, tomato, fries, soda 330ml',          price: 6500,  image_url: 'https://images.unsplash.com/photo-1550317138-10000687a72b?w=400', category: 'combo', restaurant_name: 'Quick Bites KG',  restaurant_id: 'r3', estimated_minutes: 20, rating: 4.7, is_available: true },
  { id: 'c2', name: 'Chicken + Rice + Juice',        description: 'Grilled chicken thigh with seasoned rice and fresh juice.',          ingredients: 'Grilled chicken, seasoned rice, vegetables, juice 500ml',      price: 5500,  image_url: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=400', category: 'combo', restaurant_name: 'Mama Cantine',    restaurant_id: 'r1', estimated_minutes: 25, rating: 4.8, is_available: true },
  { id: 'c3', name: 'Brochettes + Chips + Beer',     description: 'Classic Rwandan brochettes with golden chips and a cold beer.',      ingredients: 'Beef skewers, chips, Primus/Mutzig 500ml',                     price: 7000,  image_url: 'https://images.unsplash.com/photo-1544025162-d76694265947?w=400', category: 'combo', restaurant_name: 'Mama Cantine',    restaurant_id: 'r1', estimated_minutes: 25, rating: 4.9, is_available: true },
  { id: 'c4', name: 'Pizza Slice + Salad + Soda',    description: 'Two slices of margherita pizza with fresh garden salad and soda.',   ingredients: 'Pizza x2, garden salad, soda 330ml',                          price: 7500,  image_url: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=400', category: 'combo', restaurant_name: 'Roma Pizza',       restaurant_id: 'r7', estimated_minutes: 20, rating: 4.5, is_available: true },
  { id: 'c5', name: 'Breakfast Box',                 description: 'Eggs, bread, avocado, sausage and tea — a full Rwandan breakfast.',  ingredients: 'Eggs x2, bread, avocado, sausage x2, tea/coffee',             price: 4000,  image_url: 'https://images.unsplash.com/photo-1533089860892-a7c6f0a88666?w=400', category: 'combo', restaurant_name: 'Inzozi Kitchen',  restaurant_id: 'r2', estimated_minutes: 15, rating: 4.6, is_available: true },
  { id: 'c6', name: 'Family Feast Box',              description: 'Feeds 3-4. Rice, beans, brochettes, salad and soft drinks.',         ingredients: 'Rice 1kg, beans, brochettes x8, salad, sodas x3',             price: 18000, image_url: 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=400', category: 'combo', restaurant_name: 'Mama Cantine',    restaurant_id: 'r1', estimated_minutes: 35, rating: 4.8, is_available: true },
  ...
  { id: 'c8', name: 'Veggie Combo',                  description: 'Isombe, plantains, salad and passion juice — 100% plant-based.',     ingredients: 'Isombe, plantains, salad, passion juice',                     price: 4500,  image_url: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400', category: 'combo', restaurant_name: 'Inzozi Kitchen',  restaurant_id: 'r2', estimated_minutes: 20, rating: 4.5, is_available: true },
  { id: 'c9', name: 'Late Night Snack Box',          description: 'Samosas x4, chicken wings x4, chips and a dipping sauce.',           ingredients: 'Samosas, chicken wings, chips, sauces',                       price: 5500,  image_url: 'https://images.unsplash.com/photo-1527477396000-e27163b481c2?w=400', category: 'combo', restaurant_name: 'Spice Corner',    restaurant_id: 'r4', estimated_minutes: 20, rating: 4.7, is_available: true },
  { id: 'c10',name: 'Office Lunch Deal',             description: 'Rice, stew, salad and juice — clean, filling, delivered to your desk.', ingredients: 'Rice, beef stew, vegetable salad, juice 500ml',             price: 4800,  image_url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=400', category: 'combo', restaurant_name: 'Mama Cantine',    restaurant_id: 'r1', estimated_minutes: 20, rating: 4.8, is_available: true },
  { id: 's01', name: 'Solo Burger Combo',        description: 'Juicy burger, golden fries and an ice-cold Coca-Cola.',                  ingredients: '1 Burger, 1 Fries, 1 Coca-Cola 330ml',               price: 6500,  image_url: 'https://images.unsplash.com/photo-1550317138-10000687a72b?w=400', category: 'combo_1p', restaurant_name: 'Quick Bites KG', restaurant_id: 'r3', estimated_minutes: 15, rating: 4.7, is_available: true },
  { id: 's02', name: 'Chicken Stick Combo',      description: '4 crispy chicken sticks, fries and a soft drink.',                      ingredients: '4 Chicken Sticks, 1 Fries, 1 Soft Drink',            price: 5500,  image_url: 'https://images.unsplash.com/photo-1562967914-608f82629710?w=400', category: 'combo_1p', restaurant_name: 'Quick Bites KG', restaurant_id: 'r3', estimated_minutes: 15, rating: 4.5, is_available: true },
  { id: 's03', name: 'Wings Lover Combo',        description: '6 crispy chicken wings, fries and a cold Coke.',                        ingredients: '6 Chicken Wings, 1 Fries, 1 Coca-Cola 330ml',        price: 6000,  image_url: 'https://images.unsplash.com/photo-1567620832903-9fc6debc209f?w=400', category: 'combo_1p', restaurant_name: 'Spice Corner',   restaurant_id: 'r4', estimated_minutes: 15, rating: 4.6, is_available: true },
  { id: 's04', name: 'Light Meal Combo',         description: 'Fresh salad, 3 wings and a soft drink.',                                ingredients: '1 Salad, 3 Chicken Wings, 1 Soft Drink',              price: 4800,  image_url: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400', category: 'combo_1p', restaurant_name: 'Inzozi Kitchen', restaurant_id: 'r2', estimated_minutes: 10, rating: 4.4, is_available: true },
  { id: 's05', name: 'Pizza Slice Combo',        description: 'Personal pizza, fries and a Coke.',                                     ingredients: '1 Personal Pizza, 1 Fries, 1 Coca-Cola 330ml',       price: 7000,  image_url: 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=400', category: 'combo_1p', restaurant_name: 'Roma Pizza',     restaurant_id: 'r7', estimated_minutes: 20, rating: 4.5, is_available: true },
  { id: 's06', name: 'Beer Snack Combo',         description: '5 wings, fries and a cold beer.',                                       ingredients: '5 Chicken Wings, 1 Fries, 1 Beer (Primus/Mutzig)',   price: 6500,  image_url: 'https://images.unsplash.com/photo-1527477396000-e27163b481c2?w=400', category: 'combo_1p', restaurant_name: 'Spice Corner',   restaurant_id: 'r4', estimated_minutes: 15, rating: 4.8, is_available: true },
  { id: 's07', name: 'Big Appetite Combo',       description: 'Burger, 3 wings, fries and a soft drink.',                              ingredients: '1 Burger, 3 Chicken Wings, 1 Fries, 1 Soft Drink',   price: 8500,  image_url: 'https://images.unsplash.com/photo-1586190848861-99aa4a171e90?w=400', category: 'combo_1p', restaurant_name: 'Quick Bites KG', restaurant_id: 'r3', estimated_minutes: 20, rating: 4.7, is_available: true },
  { id: 'd01', name: 'Couple Burger Combo',      description: 'Two burgers, two fries, two Cokes.',                                    ingredients: '2 Burgers, 2 Fries, 2 Coca-Colas',                   price: 13000, image_url: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400', category: 'combo_2p', restaurant_name: 'Quick Bites KG', restaurant_id: 'r3', estimated_minutes: 20, rating: 4.8, is_available: true },
  { id: 'd02', name: 'Wings & Fries Combo',      description: '10 crispy wings, two fries and soft drinks.',                           ingredients: '10 Chicken Wings, 2 Fries, 2 Soft Drinks',           price: 11000, image_url: 'https://images.unsplash.com/photo-1567620832903-9fc6debc209f?w=400', category: 'combo_2p', restaurant_name: 'Spice Corner',   restaurant_id: 'r4', estimated_minutes: 20, rating: 4.6, is_available: true },
  { id: 'd03', name: 'Pizza Date Combo',         description: 'One medium pizza, fries and two Cokes.',                               ingredients: '1 Medium Pizza, 1 Fries, 2 Coca-Colas',              price: 12000, image_url: 'https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?w=400', category: 'combo_2p', restaurant_name: 'Roma Pizza',     restaurant_id: 'r7', estimated_minutes: 25, rating: 4.7, is_available: true },
  { id: 'd04', name: 'Chicken Lovers Combo',     description: '6 sticks and 8 wings with two soft drinks.',                           ingredients: '6 Chicken Sticks, 8 Chicken Wings, 2 Soft Drinks',   price: 13500, image_url: 'https://images.unsplash.com/photo-1562967914-608f82629710?w=400', category: 'combo_2p', restaurant_name: 'Quick Bites KG', restaurant_id: 'r3', estimated_minutes: 20, rating: 4.6, is_available: true },
  { id: 'd05', name: 'Light Sharing Combo',      description: 'Two fresh salads, 6 wings and soft drinks.',                           ingredients: '2 Salads, 6 Chicken Wings, 2 Soft Drinks',           price: 10000, image_url: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400', category: 'combo_2p', restaurant_name: 'Inzozi Kitchen', restaurant_id: 'r2', estimated_minutes: 15, rating: 4.5, is_available: true },
  { id: 'd06', name: 'Beer & Wings Combo',       description: '12 wings, fries and two cold beers.',                                  ingredients: '12 Chicken Wings, 1 Fries, 2 Beers',                 price: 14000, image_url: 'https://images.unsplash.com/photo-1567620832903-9fc6debc209f?w=400', category: 'combo_2p', restaurant_name: 'Spice Corner',   restaurant_id: 'r4', estimated_minutes: 20, rating: 4.9, is_available: true },
  { id: 'd07', name: 'Burger & Pizza Combo',     description: 'Medium pizza plus a burger with two soft drinks.',                     ingredients: '1 Medium Pizza, 1 Burger, 2 Soft Drinks',            price: 14500, image_url: 'https://images.unsplash.com/photo-1550317138-10000687a72b?w=400', category: 'combo_2p', restaurant_name: 'Quick Bites KG', restaurant_id: 'r3', estimated_minutes: 25, rating: 4.7, is_available: true },
  { id: 't01', name: 'Friends Burger Combo',     description: 'Three burgers, three fries and three Cokes.',                          ingredients: '3 Burgers, 3 Fries, 3 Coca-Colas',                   price: 19500, image_url: 'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=400', category: 'combo_3p', restaurant_name: 'Quick Bites KG', restaurant_id: 'r3', estimated_minutes: 25, rating: 4.7, is_available: true },
  { id: 't02', name: 'Pizza Party Combo',        description: 'Large pizza, 6 wings and three soft drinks.',                          ingredients: '1 Large Pizza, 6 Chicken Wings, 3 Soft Drinks',      price: 18000, image_url: 'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=400', category: 'combo_3p', restaurant_name: 'Roma Pizza',     restaurant_id: 'r7', estimated_minutes: 30, rating: 4.8, is_available: true },
  { id: 't03', name: 'Chicken Feast Combo',      description: '10 wings and 8 sticks, two fries and three soft drinks.',              ingredients: '10 Chicken Wings, 8 Chicken Sticks, 2 Fries, 3 Soft Drinks', price: 22000, image_url: 'https://images.unsplash.com/photo-1562967914-608f82629710?w=400', category: 'combo_3p', restaurant_name: 'Spice Corner', restaurant_id: 'r4', estimated_minutes: 30, rating: 4.8, is_available: true },
  { id: 't04', name: 'Mixed Grill Combo',        description: '2 burgers, 8 wings, 4 sticks and three soft drinks.',                  ingredients: '2 Burgers, 8 Chicken Wings, 4 Chicken Sticks, 3 Soft Drinks', price: 24000, image_url: 'https://images.unsplash.com/photo-1586190848861-99aa4a171e90?w=400', category: 'combo_3p', restaurant_name: 'Quick Bites KG', restaurant_id: 'r3', estimated_minutes: 30, rating: 4.7, is_available: true },
  { id: 't05', name: 'Beer Friends Combo',       description: '15 wings, two fries and three cold beers.',                            ingredients: '15 Chicken Wings, 2 Fries, 3 Beers',                 price: 21000, image_url: 'https://images.unsplash.com/photo-1527477396000-e27163b481c2?w=400', category: 'combo_3p', restaurant_name: 'Spice Corner',   restaurant_id: 'r4', estimated_minutes: 30, rating: 4.9, is_available: true },
  { id: 't06', name: 'Ultimate Sharing Combo',   description: 'Large pizza, 2 burgers, 10 wings, 2 fries and 3 soft drinks.',         ingredients: '1 Large Pizza, 2 Burgers, 10 Chicken Wings, 2 Fries, 3 Soft Drinks', price: 32000, image_url: 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=400', category: 'combo_3p', restaurant_name: 'Quick Bites KG', restaurant_id: 'r3', estimated_minutes: 35, rating: 5.0, is_available: true },
];

interface ShopItem {
  id: string; name: string; description: string; price: number;
  image_url: string; subcategory: 'beer' | 'soda' | 'soft'; volume: string; brand: string;
}

const SHOP_ITEMS: ShopItem[] = [
  { id: 's1',  name: 'Primus',              description: "Rwanda's most popular lager.",          price: 800,  image_url: 'https://images.unsplash.com/photo-1608270586620-248524c67de9?w=400', subcategory: 'beer', volume: '500ml', brand: 'Bralirwa' },
  { id: 's2',  name: 'Mutzig',              description: 'Premium Rwandan beer.',                 price: 900,  image_url: 'https://images.unsplash.com/photo-1518176258769-f227c798150e?w=400', subcategory: 'beer', volume: '500ml', brand: 'Bralirwa' },
  { id: 's3',  name: 'Heineken',            description: 'International premium lager.',          price: 1500, image_url: 'https://images.unsplash.com/photo-1584225064785-c62a8b43d148?w=400', subcategory: 'beer', volume: '330ml', brand: 'Heineken' },
  { id: 's4',  name: 'Amstel',              description: 'Light refreshing lager.',               price: 1200, image_url: 'https://images.unsplash.com/photo-1535958636474-b021ee887b13?w=400', subcategory: 'beer', volume: '330ml', brand: 'Heineken' },
  { id: 's5',  name: 'Guinness',            description: 'Rich dark stout.',                      price: 1400, image_url: 'https://images.unsplash.com/photo-1566633806827-5de9e4135bc0?w=400', subcategory: 'beer', volume: '500ml', brand: 'Diageo' },
  ...
  { id: 's7',  name: 'Fanta Orange',        description: 'Fizzy orange soda.',                    price: 500,  image_url: 'https://images.unsplash.com/photo-1624517452488-04d8a8a74dcc?w=400', subcategory: 'soda', volume: '500ml', brand: 'Coca-Cola' },
  { id: 's8',  name: 'Sprite',              description: 'Clean lemon-lime taste.',               price: 500,  image_url: 'https://images.unsplash.com/photo-1625772299848-391b6a87d7b3?w=400', subcategory: 'soda', volume: '500ml', brand: 'Coca-Cola' },
  { id: 's9',  name: 'Pepsi',               description: 'Bold refreshing cola.',                 price: 500,  image_url: 'https://images.unsplash.com/photo-1629203851122-3726ecdf080e?w=400', subcategory: 'soda', volume: '500ml', brand: 'PepsiCo' },
  { id: 's10', name: 'Tonic Water',         description: 'Schweppes classic tonic.',              price: 700,  image_url: 'https://images.unsplash.com/photo-1546171753-97d7676e4602?w=400', subcategory: 'soda', volume: '330ml', brand: 'Schweppes' },
  { id: 's11', name: 'Fresh Passion Juice', description: 'Locally squeezed passion fruit juice.', price: 1000, image_url: 'https://images.unsplash.com/photo-1600271886742-f049cd451bba?w=400', subcategory: 'soft', volume: '500ml', brand: 'Local' },
  { id: 's12', name: 'Fresh Mango Juice',   description: 'Cold freshly squeezed mango juice.',    price: 1000, image_url: 'https://images.unsplash.com/photo-1546173159-315724a31696?w=400', subcategory: 'soft', volume: '500ml', brand: 'Local' },
  ...
  { id: 's15', name: 'Still Water (1.5L)',  description: 'Clean drinking water.',                 price: 600,  image_url: 'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=400', subcategory: 'soft', volume: '1.5L',  brand: 'Inyange' },
];

interface PharmItem {
  id: string; name: string; description: string; usage: string; price: number;
  image_url: string; subcategory: 'sexual' | 'pain' | 'cold' | 'stomach' | 'skin'; sensitive: boolean; pack: string;
}
...
const PHARM_ITEMS: PharmItem[] = [
  ...
  { id: 'p2',  name: 'Condoms — Male (12 pack)',       description: 'Value pack of latex condoms. Discreetly packaged.',                             usage: 'Use 1 per sexual encounter. Check expiry date.',                           price: 3000, image_url: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=400', subcategory: 'sexual',  sensitive: true,  pack: '12 pcs' },
  { id: 'p3',  name: 'Female Condom (2 pack)',         description: 'Internal condom — female controlled protection.',                               usage: 'Insert before sex. Can be inserted up to 8 hours before.',                price: 1500, image_url: 'https://images.unsplash.com/photo-1559757175-0eb30cd8c063?w=400', subcategory: 'sexual',  sensitive: true,  pack: '2 pcs' },
  { id: 'p4',  name: 'Emergency Contraceptive',        description: 'Morning-after pill. Prevents pregnancy if taken within 72 hours.',             usage: 'Take 1 tablet ASAP after unprotected sex. Within 72 hrs.',                price: 2500, image_url: 'https://images.unsplash.com/photo-1550572017-edd951b55104?w=400', subcategory: 'sexual',  sensitive: true,  pack: '1 tablet' },
  { id: 'p5',  name: 'Postinor-2 (Levonorgestrel)',   description: 'Two-dose emergency contraceptive.',                                             usage: 'Tablet 1 immediately, tablet 2 after 12 hours. Within 72 hrs.',           price: 3000, image_url: 'https://images.unsplash.com/photo-1550572017-edd951b55104?w=400', subcategory: 'sexual',  sensitive: true,  pack: '2 tablets' },
  { id: 'p6',  name: 'Lubricant Gel (50ml)',           description: 'Water-based personal lubricant. Compatible with condoms.',                     usage: 'Apply to condom or body as needed.',                                       price: 2000, image_url: 'https://images.unsplash.com/photo-1559757175-0eb30cd8c063?w=400', subcategory: 'sexual',  sensitive: true,  pack: '50ml' },
  ...
  { id: 'p8',  name: 'Paracetamol 500mg',             description: 'Relieves headaches, fever and body aches.',                                     usage: 'Adults: 1-2 tablets every 4-6 hours. Max 8 tablets/day.',                price: 500,  image_url: 'https://images.unsplash.com/photo-1550572017-edd951b55104?w=400', subcategory: 'pain',    sensitive: false, pack: '10 tabs' },
  { id: 'p9',  name: 'Ibuprofen 400mg',               description: 'Anti-inflammatory. Good for period pain, toothache and swelling.',             usage: 'Adults: 1 tablet every 6-8 hours with food. Max 3/day.',                  price: 700,  image_url: 'https://images.unsplash.com/photo-1576671081837-49000212a370?w=400', subcategory: 'pain',    sensitive: false, pack: '10 tabs' },
  { id: 'p10', name: 'Aspirin 300mg',                  description: 'Pain relief and fever reducer.',                                               usage: 'Adults: 1-3 tablets every 4 hours. Take with food.',                      price: 400,  image_url: 'https://images.unsplash.com/photo-1550572017-edd951b55104?w=400', subcategory: 'pain',    sensitive: false, pack: '10 tabs' },
  { id: 'p11', name: 'Voltaren Gel (50g)',             description: 'Topical anti-inflammatory. For joints, back pain and muscle soreness.',        usage: 'Apply 2-4g to affected area 3-4 times daily.',                            price: 4500, image_url: 'https://images.unsplash.com/photo-1576671081837-49000212a370?w=400', subcategory: 'pain',    sensitive: false, pack: '50g tube' },
  { id: 'p12', name: 'Actifed Cough Syrup',           description: 'Relieves cough, runny nose and congestion.',                                   usage: 'Adults: 2 teaspoons every 4-6 hours. Max 8 teaspoons/day.',               price: 2500, image_url: 'https://images.unsplash.com/photo-1559056199-641a0ac8b55e?w=400', subcategory: 'cold',    sensitive: false, pack: '100ml' },
  { id: 'p13', name: 'Cetirizine (Antihistamine)',     description: 'Treats allergies, hay fever and itchy eyes.',                                  usage: 'Adults: 1 tablet once daily. Take at night.',                             price: 600,  image_url: 'https://images.unsplash.com/photo-1550572017-edd951b55104?w=400', subcategory: 'cold',    sensitive: false, pack: '10 tabs' },
  { id: 'p14', name: 'Strepsils Lozenges',             description: 'Soothing throat lozenges for sore throat.',                                   usage: 'Dissolve 1 lozenge in mouth every 2-3 hours. Max 8/day.',                 price: 1200, image_url: 'https://images.unsplash.com/photo-1559056199-641a0ac8b55e?w=400', subcategory: 'cold',    sensitive: false, pack: '8 lozenges' },
  { id: 'p15', name: 'Vitamin C 500mg',               description: 'Boosts immune system. Helps fight colds.',                                     usage: '1 tablet daily. Dissolve in water or chew.',                              price: 800,  image_url: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=400', subcategory: 'cold',    sensitive: false, pack: '10 tabs' },
  { id: 'p16', name: 'Oral Rehydration Salts',        description: 'Replace fluids lost from diarrhoea or vomiting.',                              usage: 'Dissolve 1 sachet in 1 litre clean water. Drink throughout the day.',     price: 300,  image_url: 'https://images.unsplash.com/photo-1559056199-641a0ac8b55e?w=400', subcategory: 'stomach', sensitive: false, pack: '5 sachets' },
  { id: 'p17', name: 'Antacid (Gaviscon)',             description: 'Relieves heartburn, acid reflux and indigestion.',                             usage: 'Adults: 2-4 tablets after meals and at bedtime.',                          price: 1500, image_url: 'https://images.unsplash.com/photo-1550572017-edd951b55104?w=400', subcategory: 'stomach', sensitive: false, pack: '16 tabs' },
  { id: 'p18', name: 'Buscopan (Stomach Cramps)',      description: 'Relieves stomach cramps, period pain and bowel spasms.',                      usage: 'Adults: 1-2 tablets up to 3 times daily.',                                price: 1200, image_url: 'https://images.unsplash.com/photo-1576671081837-49000212a370?w=400', subcategory: 'stomach', sensitive: false, pack: '10 tabs' },
];
...
const PHARM_TABS = [
  ...
  { id: 'sexual',  label: 'Sexual Health', emoji: '❤️' },
...
export function ReceiverOrderView({ onClose }: { onClose?: () => void } = {}) {
  ...
  const filteredFoods = DEMO_FOODS.filter(f => {
    ...
    const matchFilter = filter === 'all' ? true : filter === 'popular' ? f.rating >= 4.5 : filter === 'fast' ? f.estimated_minutes <= 15 : f.price <= 2000;
  ...
  function addToCart(item: any, q = 1) {
    setCart(prev => {
      ...
      return [...prev, { ...item, qty: q, category: item.subcategory || item.category || 'shop', restaurant_name: item.brand || '', restaurant_id: '', estimated_minutes: 10, rating: 5, is_available: true, ingredients: item.usage || item.description || '' }];
    });
  }
  ...
  async function placeOrder() {
    ...
    try {
      ...
      if (profileError) { setWalletError('Could not read wallet: ' + profileError.message); return; }
      ...
      const { error: deductError } = await supabase
        .from('profiles').update({ wallet_balance: balance - total }).eq('id', profile.id);
      if (deductError) { setWalletError('Wallet deduction failed: ' + deductError.message); return; }
      ...
      if (orderError) {
        ...
        setWalletError('Order failed: ' + orderError.message);
        return;
      }

      supabase.from('wallet_transactions').insert({
        user_id: profile.id, type: 'debit', amount: total,
        status: 'completed', description: `Shop order #${orderData.id.slice(0, 8)}`,
      }).then(() => {}).catch(() => {});
      ...
      setWalletError('Error: ' + (e?.message || JSON.stringify(e)));
    } finally {
      setPlacing(false);
    }
  }
  ...
  if (screen === 'success') return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '32px 24px', textAlign: 'center' }}>
      ...
      <p style={{ fontSize: '14px', color: 'var(--text3)', marginBottom: '6px' }}>Delivered to your door</p>
    ...
    return (
      <div style={{ minHeight: '100vh', background: 'var(--bg)', paddingBottom: '100px' }}>
        ...
        <div style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: '14px' }}>
          ...
          <div className="card" onClick={loadWallet} style={{ cursor: 'pointer' }}>
            ...
            {walletError && <p style={{ fontSize: '12px', color: '#ef4444', marginTop: '8px', fontWeight: 600 }}>{walletError}</p>}
          </div>
          <button onClick={placeOrder} disabled={placing || !address.trim() || (walletBalance !== null && walletBalance < total)}
  ...
  if (screen === 'cart') return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', paddingBottom: '100px' }}>
      <div style={{ background: 'var(--bg2)', padding: '14px 16px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', position: 'sticky', top: 0, zIndex: 100 }}>
        ...
        {cart.length > 0 && <button onClick={() => setCart([])} style={{ background: 'none', border: 'none', cursor: 'pointer', fontSize: '12px', color: '#ef4444', fontFamily: 'Space Grotesk, sans-serif', fontWeight: 600 }}>Clear all</button>}
      </div>
      {cart.length === 0 ? (
      ...
      <div style={{ padding: '18px' }}>
        ...
        {selected.ingredients && (
          <div className="card" style={{ marginBottom: '14px' }}>
            <p style={{ fontSize: '11px', fontWeight: 700, color: 'var(--text3)', textTransform: 'uppercase', letterSpacing: '.06em', marginBottom: '6px' }}>🥗 What's inside</p>
  ...
  if (screen === 'pharmacy') return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', paddingBottom: '100px' }}>
      ...
      <div style={{ margin: '12px 14px 0', padding: '10px 14px', background: 'rgba(139,92,246,0.08)', border: '1px solid rgba(139,92,246,0.2)', borderRadius: '10px', display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <p style={{ fontSize: '11px', color: 'rgba(139,92,246,0.9)', fontWeight: 600, lineHeight: 1.5 }}>All orders are <strong>100% discreet</strong>. Plain packaging, no labels.</p>
      </div>
            ...
            <div key={item.id} style={{ background: 'var(--card)', borderRadius: '14px', border: `1px solid ${item.sensitive ? 'rgba(139,92,246,0.2)' : 'var(--border)'}`, overflow: 'hidden' }}>
              <div style={{ display: 'flex', gap: '12px', padding: '14px' }}>
                <div style={{ width: '70px', height: '70px', borderRadius: '10px', overflow: 'hidden', flexShrink: 0, background: 'var(--bg3)' }}>
                  <img src={item.image_url} alt={item.name} style={{ width: '100%', height: '100%', objectFit: 'cover' }} onError={e => { (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1550572017-edd951b55104?w=400'; }} />
                </div>
                <div style={{ flex: 1 }}>
                  ...
                  <p style={{ fontSize: '10px', color: 'var(--text3)', marginBottom: '4px' }}>{item.pack}</p>
  ...
  if (screen === 'shop') return (
    <div style={{ minHeight: '100vh', background: 'var(--bg)', paddingBottom: '100px' }}>
      <Header title="🛍️ Drinks Shop" back={() => setScreen('home')} />
      <div style={{ display: 'flex', gap: '8px', overflowX: 'auto', padding: '12px 14px 4px', scrollbarWidth: 'none' }}>
        {SHOP_TABS.map(t => (
        ...
        {filteredShop.map(item => {
          ...
          return (
            <div key={item.id} style={{ background: 'var(--card)', borderRadius: '14px', border: '1px solid var(--border)', overflow: 'hidden' }}>
              <div style={{ position: 'relative' }}>
                <img src={item.image_url} alt={item.name} style={{ width: '100%', height: '110px', objectFit: 'cover' }} onError={e => { (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1554866585-cd94860890b7?w=400'; }} />
              ...
              <div style={{ padding: '10px' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  ...
                  <button onClick={() => addToCart(item)} style={{ width: '30px', height: '30px', borderRadius: '8px', background: inCart ? 'var(--green)' : 'var(--yellow)', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <div style={{ padding: '14px' }}>
        {filteredFoods.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '48px 24px' }}>
            ...
            <p style={{ fontWeight: 700, color: 'var(--text)' }}>No food found</p>
          </div>
        ) : (
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '12px' }}>
            {filteredFoods.map(food => {
              const inCart = cart.find(c => c.id === food.id);
              const isCombo = food.category.startsWith('combo');
              return (
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '10px' }}>
          {[
            ...
            <div key={c.screen} onClick={() => setScreen(c.screen)}
              style={{ background: c.bg, border: `1px solid ${c.border}`, borderRadius: '16px', padding: '16px 10px', textAlign: 'center', cursor: 'pointer' }}>
          ...
          <div style={{ display: 'flex', gap: '10px', overflowX: 'auto', scrollbarWidth: 'none', paddingBottom: '4px' }}>
            {SHOP_ITEMS.slice(0, 6).map(item => (
              <div key={item.id} style={{ flexShrink: 0, width: '120px', background: 'var(--card)', borderRadius: '14px', overflow: 'hidden', border: '1px solid var(--border)' }}>
                <img src={item.image_url} alt={item.name} style={{ width: '100%', height: '80px', objectFit: 'cover' }} onError={e => { (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1554866585-cd94860890b7?w=400'; }} />
